  ...
  const values = [
    {
      icon: Target,
      title: "Notre Mission",
      description: "Faciliter l'accès à la propriété pour tous les habitants de la RDC en offrant des services immobiliers de qualité et transparents.",
    },
    {
      icon: Heart,
      title: "Nos Valeurs",
      ...
      <div className="bg-gradient-to-br from-primary/10 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-20 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6" data-testid="text-page-title">
            À Propos de Safari.cd
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Votre partenaire de confiance dans l'immobilier en RDC
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mb-16">
          <Card className="p-8 md:p-12">
            <h2 className="text-2xl font-bold mb-6">Safari.cd</h2>
            <div className="space-y-4 text-muted-foreground">
              <p>
                Fondée par des professionnels passionnés de l'immobilier, <strong className="text-foreground">Safari.cd</strong>
                {" "}s'est rapidement imposée comme une référence incontournable dans le secteur immobilier en RDC.
              </p>
              <p>
        ...
        <div className="mt-16 text-center">
          <Card className="p-8 md:p-12 bg-gradient-to-r from-primary/10 to-[#8B5CF6]/10 border-primary/20">
            ...
            <p className="text-muted-foreground max-w-3xl mx-auto mb-6">
              Chez Safari.cd, chaque client est unique et mérite une attention particulière. 
            ...
            <p className="font-semibold text-foreground">
              Faites confiance à Safari.cd pour tous vos projets immobiliers en RDC !
            </p>
          </Card>
        </div>
      </div>
